...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const formattedTransactionValue = response.data.transactions.map(
      ...
      setTransactions(formattedTransactionValue);

      setBalance(formattedBalanceValue);
    }
